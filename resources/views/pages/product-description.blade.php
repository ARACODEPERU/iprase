                                            ...
                                            <div class="item-image">
                                                <div class="item-img-info">
                                                    <a href="#" target="_self" title="Xancetta bresao ">
                                                        <img src="{{ asset('themes/webpage/image/catalog/demo/product/80/2.jpg') }}"
                                                            alt="Xancetta bresao">
                                                    </a>
                                                </div>
                                            ...
                                            <div class="item-image">
                                                <div class="item-img-info">
                                                    <a href="#" target="_self" title="Chicken swinesha ">
                                                        <img src="{{ asset('themes/webpage/image/catalog/demo/product/80/4.jpg') }}"
                        ...
                        <div class="banner-sidebar banners">
                            <div>
                                <a title="Banner Image" href="#">
                                    <img src="{{ asset('themes/webpage/image/catalog/banners/banner-sidebar.jpg') }}"
                                        alt="Banner Image">
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="left-content-product">
                            ...
                            <div class="content-product-left class-honizol col-md-5 col-sm-12 col-xs-12">
                                <div class="large-image  ">
                                    <img itemprop="image" class="product-image-zoom" src="{{ asset($product->image) }}"
                                        title="{{ $product->name }}" alt="{{ $product->name }}">
                                </div>
                                <a class="thumb-video pull-left" href="{{ $product->additional3 }}"><i
                                ...
                                <div id="thumb-slider" class="yt-content-slider full_slider owl-drag" data-rtl="yes"
                                    ...
                                    data-items_column1="3" data-items_column2="4" data-items_column3="1"
                            ...
                            <div class="content-product-right col-md-7 col-sm-12 col-xs-12">
                                    ...
                                    @else
                                        <div class="product_page_price price" itemprop="offerDetails" itemscope=""
                                            ...
                                            <span class="price-new"
                                                itemprop="price">{{ number_format($product->price, 2) }}</span>
                                        </div>
                                    @endif

                                    @if ($product->existence == 1)
                                        <div class="stock">
                                            <span>Disponibilidad:</span> <span class="status-stock"
                                                style="color: green;">En Stock</span>
                                        </div>
                                    @else
                                        <div class="stock">
                                            <span>Disponibilidad:</span> <span class="status-stock"
                                        ...
                                        <div class="inner-box-desc">
                                            @if (count($product->specifications) > 0)
                                                @foreach ($product->specifications as $specification)
                                                    <div class="price-tax"><span>{{ $specification->title }}</span> {{ $specification->description }}</div>
                                                @endforeach
                                            @endif
                                        </div>
                                    </div>
                                ...
                                <div id="product">
                                        ...
                                        <ul class="product-options clearfix"id="input-option231">
                                            <li class="radio">
                                                <label>
                                                    <input class="image_radio" type="radio" name="option[231]"
                                                        value="33">
                                                    <img src="{{ asset('themes/webpage/image/demo/colors/blue.jpg') }}"
                                            ...
                                            <li class="radio">
                                                <label>
                                                    <input class="image_radio" type="radio" name="option[231]"
                                                        value="34">
                                                    <img src="image/demo/colors/brown.jpg"
                                        ...
                                        <div id="input-option232">
                                            <div class="checkbox">
                                                <label for="checkbox_1"><input type="checkbox" name="option[232][]"
                                                        value="36" id="checkbox_1"> Checkbox 1 (+$12.00)</label>
                                            </div>
                                            <div class="checkbox">
                                                <label for="checkbox_2"><input type="checkbox" name="option[232][]"
                                                        value="36" id="checkbox_2"> Checkbox 2 (+$36.00)</label>
                                            </div>
                                            <div class="checkbox">
                                                <label for="checkbox_3"><input type="checkbox" name="option[232][]"
                                                        value="36" id="checkbox_3"> Checkbox 3 (+$24.00)</label>
                                            </div>
                                            <div class="checkbox">
                                                <label for="checkbox_4"><input type="checkbox" name="option[232][]"
                                                        value="36" id="checkbox_4"> Checkbox 4 (+$48.00)</label>
                                            </div>
                                        </div>
                                    </div> --}}
                                    ...
                                    <div class="form-group box-info-product">
                                        <div class="cart">
                                            <a href="">
                                                <button type="button" class="btn btn-primary" title="Comprar Ahora"">
                            ...
                            <div class="tab-content col-lg-10 col-sm-9 col-xs-12">
                                <div id="tab-1" class="tab-pane fade active in">
                                    <p>
                                        ...
                                        flicker-free images that deliver twice the brightness, twice the sharpness and twice
                                        the contrast ratio of a typical CRT display. Unlike other flat panels, it's designed
                                        with a pure digital interface to deliver distortion-free images that never need
                                    ...
                                    <div class="product-item-container">
                                        ...
                                        <div class="right-block">
                                            ...
                                            <div class="caption hide-cont">
                                                ...
                                                <h4><a href="product.html" title="Pastrami bacon" target="_self">Duis
                                                        aute irure </a></h4>
