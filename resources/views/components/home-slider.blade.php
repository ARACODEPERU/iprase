                    ...
                    <div class="module sohomepage-slider ">
                        <div class="yt-content-slider" data-rtl="yes" data-autoplay="no" data-autoheight="no"
                            ...
                            <div class="yt-content-slide">
                                <a href="#"><img
                                        src="{{ asset('themes/webpage/image/catalog/slideshow/home1/slider-1.jpg') }}"
                                        alt="slider1" class="img-responsive"></a>
                            </div>
                            <div class="yt-content-slide">
                                <a href="#"><img
                                        src="{{ asset('themes/webpage/image/catalog/slideshow/home1/slider-2.jpg') }}"
                                        alt="slider2" class="img-responsive"></a>
                            </div>
                            <div class="yt-content-slide">
                                <a href="#"><img
                                        src="{{ asset('themes/webpage/image/catalog/slideshow/home1/slider-3.jpg') }}"
