<div>
    <div id="so_category_slider_1" class="so-category-slider container-slider module cateslider1">
        <div class="modcontent">
            <div class="page-top">
                <div class="page-title-categoryslider">Zapatillas</div>
                            ...
                            <div class="product-item-container">
                                ...
                                <div class="right-block">
                                    ...
                                    <div class="caption hide-cont">
                                        ...
                                        <h4><a href="product.html" title="Pastrami bacon" target="_self">Duis aute irure
                                            </a></h4>
                            ...
                            <div class="product-item-container">
                                ...
                                <div class="right-block">
                                    <div class="button-group so-quickview cartinfo--left">
                                        ...
                                        <button type="button" class="wishlist btn-button" title="Add to Wish List"
                                            onclick="wishlist.add('60');"><i class="fa fa-heart-o"></i><span>Add to
                                                Wish
                                                List</span>
                                        </button>
