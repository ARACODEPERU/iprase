                                ...
                                <div class="btn-group languages-block ">
                                    <form action="" method="post" enctype="multipart/form-data" id="bt-language">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li> 
                                                <a href="">
                                                    <img class="image_flag" src="image/catalog/flags/ar.png" alt="Arabic" title="Arabic" /> 
                                                    Arabic 
                                                </a>
                                            </li>
                                        </ul>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="navbar-logo col-lg-2 col-md-3 col-sm-4 col-xs-12">
                        <div class="logo">
                            <a href="">
                                <img src="{{ asset('themes/webpage/image/catalog/logo.png') }}" title="Your Store" alt="Your Store" />
                            </a>
                        </div>
                    </div>
                    <!-- //end Logo -->
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="text-center" style="width:70px">
                                                        <a href="product.html">
                                                            <img src="{{ asset('themes/webpage/image/catalog/demo/product/80/1.jpg') }}" style="width:70px" alt="Yutculpa ullamcon" title="Yutculpa ullamco" class="preview">
                                                        </a>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td class="text-center" style="width:70px">
                                                        <a href="product.html">
                                                            <img src="{{ asset('themes/webpage/image/catalog/demo/product/80/2.jpg') }}" style="width:70px" alt="Xancetta bresao" title="Xancetta bresao" class="preview">
                                                        </a>
                                                    </td>
                                                    ...
                                                    <ul class="megamenu">
                                                        <li class="item-vertical  with-sub-menu hover">
                                                            ...
                                                            <a href="#" class="clearfix">
                                                                <img src="{{ asset('themes/webpage/image/catalog/menu/icons/ico10.png') }}" alt="icon">
                                                        ...
                                                        <li class="item-vertical" style="display: none;">
                                                            <p class="close-menu"></p>
                                                            <a href="#" class="clearfix">
                                                                 <img src="{{ asset('themes/webpage/image/catalog/menu/icons/ico11.png') }}" alt="icon">
                                                ...
                                                <ul class="megamenu" data-transition="slide" data-animationtime="250">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-3">
                                                                        <a href="index.html" class="image-link"> 
                                                                            <span class="thumbnail">
                                                                                <img class="img-responsive img-border" src="{{ asset('themes/webpage/image/catalog/menu/home-1.jpg') }}" alt="">
                                                                    ...
                                                                    <div class="col-md-3">
                                                                        <a href="home2.html" class="image-link"> 
                                                                            <span class="thumbnail">
                                                                                <img class="img-responsive img-border" src="{{ asset('themes/webpage/image/catalog/menu/home-2.jpg') }}" alt="">
                                                                    ...
                                                                    <div class="col-md-3">
                                                                        <a href="home3.html" class="image-link"> 
                                                                            <span class="thumbnail">
                                                                                <img class="img-responsive img-border" src="{{ asset('themes/webpage/image/catalog/menu/home-3.jpg') }}" alt="">
                                                                    ...
                                                                    <div class="col-md-3">
                                                                        <a href="html_with_RTL/index.html" class="image-link"> 
                                                                            <span class="thumbnail">
                                                                                <img class="img-responsive img-border" src="{{ asset('themes/webpage/image/catalog/menu/rtl.jpg') }}" alt="">
                                                    ...
                                                    <li class="with-sub-menu hover">
                                                        ...
                                                        <a href="#" class="clearfix">
                                                            ...
                                                            <img class="label-hot" src="{{asset('themes/webpage/image/catalog/menu/new-icon.png')}}" alt="icon items">
                                                            <b class="caret"></b>
                                                        </a>
                                                                    ...
                                                                    <div class="col-sm-12">
                                                                        <div class="row">
                                                                            <div class="col-md-3 img img1">
                                                                                <a href="#"><img src="{{ asset('themes/webpage/image/catalog/menu/megabanner/image-1.jpg') }}" alt="banner1"></a>
                                                                            </div>
                                                                            <div class="col-md-3 img img2">
                                                                                <a href="#"><img src="{{ asset('themes/webpage/image/catalog/menu/megabanner/image-2.jpg') }}" alt="banner2"></a>
                                                                            </div>
                                                                            <div class="col-md-3 img img3">
                                                                                <a href="#"><img src="{{asset('themes/webpage/image/catalog/menu/megabanner/image-3.jpg')}}" alt="banner3"></a>
                                                                            </div>
                                                                            <div class="col-md-3 img img4">
                                                                                <a href="#"><img src="{{ asset('themes/webpage/image/catalog/menu/megabanner/image-4.jpg') }}" alt="banner4"></a>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
